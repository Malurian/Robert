    ...
    <div class="container">
        ...
        <section id="content" class="content col-sm-12 col-md-8 col-lg-9">
            ...
            <div class="owl-carousel img-carousel">
                <div class="item">
                    <div class="img-responsive">{{$event->image}}</div>
                </div>
                                ...
                                <div class="timeline">
                                    ...
                                    <article class="post-wrap">
                                        <div class="media">
                                            ...
                                            <div class="post-media pull-left">
                                                <img src="{{ URL::asset('assets/img/preview/avatar-v2-1.jpg') }}" alt="" class="media-object" />
                                    ...
                                    <article class="post-wrap">
                                        <div class="media">
                                            <!-- -->
                                            <div class="post-media pull-left">
                                                <img src="{{ URL::asset('assets/img/preview/avatar-v2-3.jpg') }}" alt="" class="media-object" />
                                                <span class="about"><strong>John Doe</strong></span>
                                                <span class="about">CEO at Crown.io</span>
                                            </div>
                                            <!-- -->
                                ...
                                <div class="timeline">
                                    ...
                                    <article class="post-wrap">
                                        <div class="media">
                                            <!-- -->
                                            <div class="post-media pull-left">
                                                <img src="{{ URL::asset('assets/img/preview/avatar-v2-2.jpg') }}" alt="" class="media-object" />
                                            </div>
                                            <!-- -->
                                            <div class="media-body">
                                                <div class="post-header">
                                    ...
                                    <article class="post-wrap">
                                        <div class="media">
                                            <!-- -->
                                            <div class="post-media pull-left">
                                                <img src="{{ URL::asset('assets/img/preview/avatar-v2-4.jpg') }}" alt="" class="media-object" />
                                            </div>
                                            <!-- -->
                                            <div class="media-body">
                                                <div class="post-header">
                                    ...
                                    <div class="rehex-deg">
                                        <div class="rehex-deg">
                                            <div class="rehex-inner">
                                                <div class="media">
                                                    <img src="{{ URL::asset('assets/img/preview/speaker-1.jpg') }}" alt="">
                                ...
                                <div class="rehex speaker-avatar">
                                    <div class="rehex-deg">
                                        <div class="rehex-deg">
                                            <div class="rehex-inner">
                                                <div class="media">
                                                    <img src="{{ URL::asset('assets/img/preview/speaker-2.jpg') }}" alt="">
                                                    <div class="caption hovered">
                                                        <div class="caption-wrapper div-table">
                                                            <div class="caption-inner div-cell">
                                                                <p class="caption-buttons"><a href="#" class="btn caption-link"><i class="fa fa-link"></i></a></p>
                                ...
                                <div class="rehex speaker-avatar">
                                    <div class="rehex-deg">
                                        <div class="rehex-deg">
                                            <div class="rehex-inner">
                                                <div class="media">
                                                    <img src="{{ URL::asset('assets/img/preview/speaker-3.jpg') }}" alt="">
                                                    <div class="caption hovered">
                                                        <div class="caption-wrapper div-table">
                                                            <div class="caption-inner div-cell">
                                                                <p class="caption-buttons"><a href="#" class="btn caption-link"><i class="fa fa-link"></i></a></p>
                        ...
                        <div class="isotope-item festival">
                            <div class="thumbnail no-border no-padding">
                                <div class="media">
                                    ...
                                    <img src="{{ URL::asset('assets/img/preview/hotel-1.jpg') }}" alt="">
