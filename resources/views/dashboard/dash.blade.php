					...
					<div class="container-fluid">
						<div class="d-flex">
							<a class="header-brand" href="index-1.html">
								<img src="dashboard\assets\images\brand\logo.png" class="header-brand-img" alt="Company Name">
							</a>
								...
								<div class="dropdown text-center selector">
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
										<div class="text-center">
											<a href="#" class="dropdown-item text-center font-weight-sembold user" data-toggle="dropdown">User Name here</a>
